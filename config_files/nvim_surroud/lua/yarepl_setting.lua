...
vim.api.nvim_set_keymap("n", "<localleader>r", "<cmd>REPLStart<CR>", {noremap = true, silent = true})
vim.api.nvim_set_keymap("n", "<localleader>c", "<cmd>REPLClose<CR>", {noremap = true, silent = true})
