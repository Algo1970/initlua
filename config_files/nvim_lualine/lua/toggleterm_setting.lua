...
vim.api.nvim_set_keymap("v", "<localleader>s", ":'<,'><C-u>ToggleTermSendVisualSelection<CR>", {noremap = true, silent = true})
vim.api.nvim_set_keymap("n", "<localleader>p", "vipj:<C-u>ToggleTermSendVisualSelection<CR>", {noremap = true, silent = true})
